...
(3) Create a custom-template to for unsupported ODN CFP commands. Need to include subordinate ODN policies
...
(4) Ensure that a headless odn template called DSC_Flow for color 500 has been created referencing the custom template:
cisco-sr-te-cfp:sr-te odn odn-template DSCP_Flow
 custom-template ct-color-500-flow
 color 500
! 

(5) Build the proper slicing template:
